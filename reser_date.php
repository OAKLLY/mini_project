...
<html>
    ...
    <H1 class="text-center fw-bolder" style="color:#0d6efd;">Select booking date</H1><hr><br>
    ...
    <button class="btn btn-primary w-50" type="submit" onclick="return confirm('ยืนยันหรือไม่ !!');">จอง</button>
    </div>
        </form>
            </div>
</div>
