...
<body>
    ...
    <div class="container" style="margin-top:20px">  
       <h3 class="text-center fw-bold fs-1">ADMIN SETUP</h3> 
       
                <form action="admin_add_db.php" method="post" enctype="multipart/form-data">
                    <input class="form-check-radio mb-3" type="radio" name="ROOM_DETAIL"  value="ชาย">ชาย
                    <input class="form-check-radio mb-3" type="radio" name="ROOM_DETAIL"  value="หญิง">หญิง
                    <input class="form-control mb-3" type="text" name="detail"  placeholder="รายละเอียด">
                    <input class="form-control" type="text" name="ROOM_PRICE"  placeholder="ราคาต่อเดือน"><br><br>
                ...
                <table class="table table-striped  table-hover table-responsive table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $k['ROOM_STATUS'];?></td>
                            <td><a href="admin_edit.php?ROOM_ID=<?= $k['ROOM_ID']; $_SESSION['id'] = $k['ROOM_ID']?>" class="btn btn-warning btn-sm d-flex justify-content-center">แก้ไข</a></td>
                                <td><a href="admin_del.php?ROOM_ID=<?= $k['ROOM_ID']; $_SESSION['id'] = $k['ROOM_ID']; ?>" class="btn btn-danger btn-sm d-flex justify-content-center" onclick="return confirm('ยืนยันการลบข้อมูล !!');">ลบ</a></td>
