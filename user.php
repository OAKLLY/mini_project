        ...
        <tr>
                        ...
                        <?php 
                              ...
                              if(!isset($mys['student_id'])){?>
                                ...
                                <td><a href="reser_user.php?ROOM_ID=<?php echo $row['ROOM_ID'];?>" class="btn btn-primary">เลือก</a> </td>
                              <?php } 
                              else {?>

                                <td><a href="user.php"  class="btn btn-success" onclick="return confirm('คุณได้จองเรียบร้อยแล้ว !!');">เลือก</a> </td>
                              <?php }?>
